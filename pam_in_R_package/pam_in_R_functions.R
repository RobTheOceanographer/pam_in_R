...
# credits: Robert Johnson, Shihong Lee, Simon Reeves, Emma Flukes
# version: 1.1
...
raw_file_data <- pam_file_reader('T9allsites and Tfinal Mn.csv')
...
# un-touched from here on.... ->
pam_platt_fit <- function(pam_qc_data,calcBetaSwitch){
  #------------------------------------------------------------------------------------------------------------#
  # This function takes a light curve and fits the platt equation to it.
  #
  # USAGE: platt_fitted_pam_data <- pam_platt_fit(pam_qc_data)
  #
  # author: Robert Johnson
  # version: 0.1
  # maintainer: Robert Johnson
